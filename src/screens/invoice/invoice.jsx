...
const Invoice = () => {
  ...
  const calculateSubtotal = () => {
    const result = fields.items.reduce(
      (total, item) => total + item.duration * item.rate,
      0,
    );
    return result;
  };
                ...
                <XStack justifyContent="flex-start" alignItems="center">
                  <YStack flex={0.5}>
                    ...
                    <StyledButton
                      ...
                      onPress={() => {
                        setSelectedUnit(selecteUnit === 'hour' ? 'day' : 'hour');
                      }}>
                      <StyledText
                        paddingHorizontal={4}
                        paddingVertical={5}
                  ...
                  <YStack flex={1} marginLeft={8}>
                    <StyledText
                      ...
                      textAlign="left"
                      readOnly
                      color={theme.colors.gray[800]}>Time</StyledText>
                    <StyledInput
                      keyboardType="default"
                      placeholder=""
                      returnKeyType="next"
                      ...
                      onChangeText={value =>
                        value && handleChange('duration', parseFloat(value))
                      }
                ...
                return (
                  <XStack
                    ...
                    <StyledInput
                      ...
                      paddingHorizontal={8}
                      marginHorizontal={1}
                      value={item.duration ? item.duration.toFixed() : ''}
                      placeholderTextColor={theme.colors.gray[300]}
                      readOnly
                    />
                    <StyledInput
